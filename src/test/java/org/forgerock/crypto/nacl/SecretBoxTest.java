...
public class SecretBoxTest {
    ...
    public void shouldProduceCorrectKeyStream() throws IOException {
        ...
        SecretBox encrypted = SecretBox.encrypt(key, nonce, plaintext.clone());
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            out.flush();
            received = SecretBox.readFrom(new ByteArrayInputStream(out.toByteArray()));
        }

        byte[] decrypted = received.decrypt(key);
    ...
    public void shouldBeIdempotentForDecryption() {
        ...
        SecretBox box = SecretBox.encrypt(key, plaintext);

        String decrypt1 = box.decryptToString(key);
        String decrypt2 = box.decryptToString(key);
